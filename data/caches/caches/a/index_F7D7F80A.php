<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:40:"/data/web/vshop/themes/default/index.dwt";i:1;s:52:"/data/web/vshop/themes/default/library/cat_goods.lbi";i:2;s:58:"/data/web/vshop/themes/default/library/page_index_menu.lbi";i:3;s:55:"/data/web/vshop/themes/default/library/search_index.lbi";i:4;s:54:"/data/web/vshop/themes/default/library/page_footer.lbi";}s:7:"expires";i:1515570389;s:8:"maketime";i:1515566789;}<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<!--header class="index-header comWidth">
  <i class="index-header-menu iconfont fl" onclick="window.location = '/vshop/index.php?m=default&c=category&a=top_all&u=200'">&#xe627;</i>
...
<div class="index-more-icon"><span>双汇冷鲜猪肉</span></div>
    ...
    <div class="single_item">
        <li class="fl" style="background-color: #FFFFFF;">
          <a href="/vshop/index.php?m=default&c=goods&a=index&id=173&u=200"><img src="http://www.disanqiche.com/vshop/images/201711/goods_img/173_G_1509510795715.jpg" alt="双汇冷鲜猪肉" /></a>
      <a href="/vshop/index.php?m=default&c=goods&a=index&id=173&u=200"><p>双汇冷鲜猪肉</p></a>
      <span>￥11.98</span>
    </li>
    </div>
...
<footer class="index-footer comWidth">
	<ul>
	<li class="fl index-footer-list"><a href="/vshop/index.php?m=default&c=index&a=index&u=200"><i class="iconfont">&#xe621;</i><span>首页</span></a></li>
	<li class="fl index-footer-list"><a href="/vshop/index.php?m=default&c=category&a=top_all&u=200"><i class="iconfont">&#xe627;</i><span>分类</span></a></li>
	<li class="fl index-footer-list"><a href="javascript:openSearch();"><i class="iconfont">&#xe617;</i><span>搜索</span></a></li>
	<li class="fl index-footer-list"><a href="/vshop/index.php?m=default&c=flow&a=cart&u=200"><i class="iconfont">&#xe626;</i><span>购物车</span></a></li>
		<li class="fl index-footer-list"><a href="/vshop/index.php?m=default&c=user&a=index&u=200"><i class="iconfont">&#xe625;</i><span>用户中心</span></a></li>
...
<div class="search" style="display:none;">
	...
	<div class="ect-padding-lr">
		<form action="/vshop/index.php?m=default&c=category&a=index&u=200"  method="post" id="searchForm" name="searchForm">
...
get_asynclist("/vshop/index.php?m=default&c=index&a=ajax_goods&type=best&u=200" , '__TPL__/images/loader.gif');
</script>
<script>
	/*立即关注*/
	$(function($) {
