...
<div class="ect-padding-lr ect-padding-tb ect-margin-tb"> <a href="<?php echo url('user/add_address');?>" type="botton" class="btn btn-info ect-btn-info ect-colorf ect-bg"><?php echo $this->_var['lang']['add_address']; ?></a> </div>
</div>
