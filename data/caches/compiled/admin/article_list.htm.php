...
?>
  <tr>
    ...
    <img src="images/<?php if ($this->_var['list']['is_open'] == 1): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_show', <?php echo $this->_var['list']['article_id']; ?>)" /></span><?php else: ?><span><img src="images/yes.gif" alt="yes" onclick="listTable.toggle(this, 'toggle_show', <?php echo $this->_var['list']['article_id']; ?>)" /></span><?php endif; ?></td>
    <td align="center"><span><?php echo $this->_var['list']['date']; ?></span></td>
    <td align="center" nowrap="true"><span>
      <a href="../index.php?c=article&a=info&aid=<?php echo $this->_var['list']['article_id']; ?>" target="_blank" title="<?php echo $this->_var['lang']['view']; ?>"><img src="images/icon_view.gif" border="0" height="16" width="16" /></a>&nbsp;
