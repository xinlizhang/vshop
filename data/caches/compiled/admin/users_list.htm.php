...
<div class="form-div">
    ...
    &nbsp;<?php echo $this->_var['lang']['label_user_name']; ?> &nbsp;<input type="text" name="keyword" /> <input type="submit" onclick="userexport('javascript:searchUser()')" value="<?php echo $this->_var['lang']['button_search']; ?>" />
